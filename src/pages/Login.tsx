...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-forest to-forest-light flex items-center justify-center">
      <div className="w-full max-w-md space-y-8 p-8 bg-white rounded-lg shadow-xl">
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link to="/signup" className="text-sky hover:text-sky-light font-medium">
            Sign up
          </Link>
        </p>
      </div>
